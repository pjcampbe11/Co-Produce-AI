...
TOOLS = [
    ...
    ("\U0001F52A Sample chop (MPC/Push)", "sample_chop.py", [
        F("--input", "Source WAV/MP3", "text"),
        F("--producer", "Producer style", "choice", "",
          ["", "j_dilla", "kanye_west", "dj_premier", "9th_wonder", "rza", "madlib",
           "pete_rock", "just_blaze", "the_alchemist", "knxwledge"]),
        F("--bpm", "BPM", "num", 90),
        F("--bars", "Bars/variation", "num", 2),
        F("--pads", "Max slices (pads)", "num", 16),
        F("--grid", "Even slices/bar (0=transient)", "num", 0),
        F("--target", "Export", "choice", "both", ["mpc", "ableton", "both"]),
        F("--adg", "Ableton Drum Rack .adg", "bool", False),
        F("--stems", "AI: chop melodic stem", "bool", False),
        F("--reimagine", "AI: audio2audio flip", "bool", False),
        F("--out", "Output folder", "text", "chops"),
    ]),
...
def build_ui():
    with gr.Blocks(title="Co-Produce AI \u2014 Dashboard", theme=THEME, css=CSS) as app:
        ...
        SECTIONS = [
            ...
            ("\U0001F941 Beats & Sound", ["sample_chop.py", "beat_builder.py", "vst_instrument.py", "vst_chain.py"]),
