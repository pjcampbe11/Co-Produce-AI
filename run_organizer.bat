...
.venv\Scripts\python scripts\07_organize_soundbank.py --input "F:\Sound Bank" --output "F:\Sound Bank Organized" --dry-run
echo.
echo Dry run done - review "F:\Sound Bank Organized\review.csv".
set /p GO="Type YES to run for real (copies files): "
if /i "%GO%"=="YES" .venv\Scripts\python scripts\07_organize_soundbank.py --input "F:\Sound Bank" --output "F:\Sound Bank Organized" --resume
